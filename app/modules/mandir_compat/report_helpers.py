        ...
        out.append(
            {
                ...
                'donation_type': str(doc.get('donation_type') or 'cash'),
                'in_kind_item_name': str(doc.get('in_kind_item_name') or ''),
                'in_kind_item_type': str(doc.get('in_kind_item_type') or ''),
                'in_kind_quantity': str(doc.get('in_kind_quantity') or ''),
                'in_kind_valuation_basis': str(doc.get('in_kind_valuation_basis') or ''),
                'valuation_status': str(doc.get('valuation_status') or ''),
                'approved_value': str(doc.get('approved_value') or ''),
                'valuation_approval_basis': str(doc.get('valuation_approval_basis') or ''),
                'valuation_approved_by': str(doc.get('valuation_approved_by') or ''),
                'inventory_item_id': str(doc.get('inventory_item_id') or ''),
                'inventory_quantity': str(doc.get('inventory_quantity') or ''),
                'inventory_movement_id': str(doc.get('inventory_movement_id') or ''),
                'event_name': str(doc.get('event_name') or ''),
                'fund_id': str(doc.get('fund_id') or ''),
                'fund_name': str(doc.get('fund_name') or ''),
                'fund_type': str(doc.get('fund_type') or ''),
                'fund_dimension_id': str(doc.get('fund_dimension_id') or ''),
                'festival_id': str(doc.get('festival_id') or ''),
                'festival_name': str(doc.get('festival_name') or ''),
                'is_sponsorship': bool(doc.get('is_sponsorship')),
                'income_category': str(doc.get('income_category') or ''),
                'status': str(doc.get('status') or 'posted'),
                'reversal_journal_id': doc.get('reversal_journal_id'),
                'cancellation_reason': str(doc.get('cancellation_reason') or ''),
                ...
                '80g_eligibility_status': str(doc.get('80g_eligibility_status') or 'not_requested'),
                'donor_pan': str(doc.get('donor_pan') or ''),
                'is_foreign_contribution': bool(doc.get('is_foreign_contribution')),
                'fcra_status': str(doc.get('fcra_status') or 'not_applicable'),
                'donor_country': str(doc.get('donor_country') or ''),
        ...
        rows.append(
            {
                ...
                'in_kind_item_name': donation.get('in_kind_item_name'),
                'in_kind_item_type': donation.get('in_kind_item_type'),
                'in_kind_quantity': donation.get('in_kind_quantity'),
                'in_kind_valuation_basis': donation.get('in_kind_valuation_basis'),
                'valuation_status': donation.get('valuation_status'),
                'approved_value': donation.get('approved_value'),
                'valuation_approval_basis': donation.get('valuation_approval_basis'),
                'valuation_approved_by': donation.get('valuation_approved_by'),
                'inventory_item_id': donation.get('inventory_item_id'),
                'inventory_quantity': donation.get('inventory_quantity'),
                'inventory_movement_id': donation.get('inventory_movement_id'),
                'event_name': donation.get('event_name'),
                'fund_id': donation.get('fund_id'),
                'fund_name': donation.get('fund_name'),
                'fund_type': donation.get('fund_type'),
                'fund_dimension_id': donation.get('fund_dimension_id'),
                'festival_id': donation.get('festival_id'),
                'festival_name': donation.get('festival_name'),
                'is_sponsorship': donation.get('is_sponsorship'),
                'income_category': donation.get('income_category'),
                'status': donation.get('status'),
                'reversal_journal_id': donation.get('reversal_journal_id'),
