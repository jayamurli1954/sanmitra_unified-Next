...
from app.modules.temple.schemas import (
    DonationCreateRequest,
    DonationCreateResponse,
    SevaCollectionCreateRequest,
    SevaCollectionCreateResponse,
)
from app.modules.temple.service import record_donation, record_seva_collection
...
@router.post("/seva-collections", response_model=SevaCollectionCreateResponse)
async def create_seva_collection(
    ...
    try:
        seva_collection = await record_seva_collection(
            session,
            tenant_id=tenant_id,
            app_key=app_key,
            created_by=current_user.get("sub", "system"),
    ...
    return SevaCollectionCreateResponse(**seva_collection)
