...
6. Review workspaces (ADR-015) and Documents (ADR-016) stay **off** this ERP demo tenant. Use [`OFFICEMITRA_REVIEW_SMOKE_CHECKLIST.md`](OFFICEMITRA_REVIEW_SMOKE_CHECKLIST.md) and [`OFFICEMITRA_DOCUMENTS_SMOKE_CHECKLIST.md`](OFFICEMITRA_DOCUMENTS_SMOKE_CHECKLIST.md) on `demo-mfg-mis` only.
