...
- Staging non-destructive smoke passed on 2026-05-22 for login/module context, tabs, receipt preview/download, Panchang, reports, balanced accounting reports, and public no-login UPI/config visibility.
