...
- [~] Dimensions/tagging coverage across vouchers, invoices, bills, notes, reports, and exports. Document-level tags and reports are now covered for invoices, bills, credit notes, and debit notes with local API and mocked-shell browser coverage; voucher tags, per-line dimensions, export hardening, and production signoff remain open.
