...
| 2026-05-22 | MandirMitra demo public payment submission | Demo-only UX added | `/mandir-public/` can create pending public payments only for demo/test tenants; live trusts remain visibility-only | Verify the pending demo payment through ERP Public Payments and confirm receipt/accounting posting |
