...
| 2026-05-22 | MandirMitra sponsorship accounting | Backend posting covered | Cash sponsorship posts to Sponsorship Income; valued in-kind Annadanam posts to expense when inventory is off and inventory when inventory is on; precious articles classify to temple asset accounts; focused tests pass | Add UI fields, valuation approval, stock consumption, and event/fund subledger reporting in a later slice |
