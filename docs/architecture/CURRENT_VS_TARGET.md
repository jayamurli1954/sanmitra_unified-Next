...
- Implemented but not production-ready: MitraBooks admin settings now save tenant-scoped business, billing, integration, and AI review-first configuration shells; CA Practice Portal now includes tenant-scoped client records, company switching, document queues, and attachments; the CA acceptance frontend UX, deeper browser E2E, and wider CA practice model are still pending.
