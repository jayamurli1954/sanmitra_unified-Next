...
| OfficeMitra AI | Phases 1–6 + ADR-012 Policy Engine implemented locally; ADR-008/009/012 Accepted; ADR-010–011 Proposed; ADR-013 Future | Staging smoke for Phase 3–6 + policy; companion writes blocked until ADR-010 | Run Phase 3–6 and policy checklists; keep companion connectors read-only |
