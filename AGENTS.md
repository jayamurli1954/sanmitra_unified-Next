...
- CA Analysis Pack (ADR-014): MIS facts immutable after reconcile/export; template Excel import v1; narrative requires fact citations; no journal/invoice/GST writes from MIS flows; PPT export defaults to maker-checker.
