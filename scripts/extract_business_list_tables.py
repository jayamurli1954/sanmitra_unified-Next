#!/usr/bin/env python3
"""Extract parties/vouchers list table renderers (Phase 3 seam 42)."""
...
OUT = ROOT / "frontend/mitrabooks-erp/modules/workspaces/business-list-tables.js"
...
def main() -> None:
    if OUT.exists() and "export function renderBusinessPartiesTable" in OUT.read_text(encoding="utf-8"):
    ...
    block = block.replace("businessListState", "getBusinessListState()")
